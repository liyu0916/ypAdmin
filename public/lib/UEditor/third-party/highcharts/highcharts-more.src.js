...
var radialAxisMixin = {
	...
	// Circular axis around the perimeter of a polar v-charts
	...
	// Radial axis, like a spoke in a polar v-charts
	...
	/**
	 * Translate from intermediate plotX (angle), plotY (axis.len - radius) to final v-charts coordinates.
	 */
	...
	getPlotBandPath: function (from, to, options) {
		var center = this.center,
			...
			open,
			isCircular = this.isCircular, // X axis in a polar v-charts
			ret;
...
var GaugeSeries = {
	...
	// v-charts.angular will be set to true when a gauge series is present, and this will
	// be used on the axes
	angular: true,
	drawGraph: noop,
	fixedBox: true,
...
function initArea(proceed, chart, options) {
	...
	if (this.chart.polar) {
		 ...
		 * goes down to the threshold, in the polar v-charts it goes to the center.
		 */
...
/**
 * Extend translate. The plotX and plotY values are computed as if the polar v-charts were a
