 ...
 * external source, and parsed. The first argument passed is a finished v-charts options
 * object, containing series and an xAxis with categories if applicable. Thise options
 * can be extended with additional options and passed directly to the v-charts constructor.
 *
 * - csv : String
